class PipelinesController < ApplicationController
  before_action :set_pipeline, only: [:show, :edit, :update, :destroy, :link]

  # GET /pipelines
  # GET /pipelines.json
  def index
    @pipelines = Pipeline.all
    @categories = Category.where('categories.pipeline_id = NULL')
  end
  ...
  private
    ...
    def pipeline_params
      params.require(:pipeline).permit(:name, :description,:categories)
    end
end
